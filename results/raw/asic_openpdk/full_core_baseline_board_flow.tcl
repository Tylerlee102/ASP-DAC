...
read_verilog results/raw/asic_openpdk/full_core_baseline_board_yosys_area_mapped.v
link_design full_core_baseline_board_top
read_sdc constraints/asic_openpdk.sdc
initialize_floorplan -site FreePDK45_38x28_10R_NP_162NW_34O -die_area {0 0 344.982 344.982} -core_area {20.000 20.000 324.982 324.982}
...
rc_try write_def {write_def results/raw/asic_openpdk/full_core_baseline_board_openroad.def}
if {[llength [info commands write_db]] != 0} { rc_try write_db {write_db results/raw/asic_openpdk/full_core_baseline_board_openroad.odb} }
