...
read_verilog results/raw/asic_openpdk/full_core_v2_minimal_board_yosys_area_mapped.v
link_design full_core_replaycapsule_v2_board_top
read_sdc constraints/asic_openpdk.sdc
initialize_floorplan -site FreePDK45_38x28_10R_NP_162NW_34O -die_area {0 0 347.654 347.654} -core_area {20.000 20.000 327.654 327.654}
...
rc_try write_def {write_def results/raw/asic_openpdk/full_core_v2_minimal_board_openroad.def}
if {[llength [info commands write_db]] != 0} { rc_try write_db {write_db results/raw/asic_openpdk/full_core_v2_minimal_board_openroad.odb} }
