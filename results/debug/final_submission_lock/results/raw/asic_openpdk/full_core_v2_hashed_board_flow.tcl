...
initialize_floorplan -site FreePDK45_38x28_10R_NP_162NW_34O -die_area {0 0 374.462 374.462} -core_area {20.000 20.000 354.462 354.462}
...
rc_try write_def {write_def results/raw/asic_openpdk/full_core_v2_hashed_board_openroad.def}
if {[llength [info commands write_db]] != 0} { rc_try write_db {write_db results/raw/asic_openpdk/full_core_v2_hashed_board_openroad.odb} }
