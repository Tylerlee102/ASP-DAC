...
IVERILOG_TESTS = (
    ...
    IverilogTest(
        name="tb_rcv2_capsule_source",
        workdir=Path("tb/system"),
        sources=("tb_rcv2_capsule_source.sv", "../../rtl/replaycapsule_v2/rcv2_capsule_source.sv"),
        include_dirs=("../../rtl", "../../rtl/replaycapsule_v2"),
    ),
    IverilogTest(
        name="tb_rcv2_replay_mode_controller",
        workdir=Path("tb/system"),
        sources=("tb_rcv2_replay_mode_controller.sv", "../../rtl/replaycapsule_v2/rcv2_replay_mode_controller.sv"),
        include_dirs=("../../rtl", "../../rtl/replaycapsule_v2"),
    ),
    IverilogTest(
        name="tb_rcv1_capsule_replay_checker",
        workdir=Path("tb/system"),
        sources=("tb_rcv1_capsule_replay_checker.sv", "../../rtl/replaycapsule_v1/rcv1_capsule_replay_checker.sv"),
        include_dirs=("../../rtl", "../../rtl/replaycapsule_v1"),
    ),
    IverilogTest(
        name="tb_rcv1_mmio_replay_driver",
        workdir=Path("tb/system"),
        sources=("tb_rcv1_mmio_replay_driver.sv", "../../rtl/replaycapsule_v1/rcv1_mmio_replay_driver.sv"),
        include_dirs=("../../rtl", "../../rtl/replaycapsule_v1"),
    ),
    IverilogTest(
    ...
    IverilogTest(
        name="tb_picorv32_standalone_self_replay_smoke",
        workdir=Path("tb/system"),
        sources=(
            "tb_picorv32_standalone_self_replay_smoke.sv",
            "../../third_party/picorv32/picorv32.v",
            "../../rtl/event_tap.sv",
            "../../rtl/event_classifier.sv",
            "../../rtl/capsule_buffer.sv",
    ...
    IverilogTest(
        name="tb_femtorv32_sensor_threshold_smoke",
        workdir=Path("tb/system"),
        sources=(
            "tb_femtorv32_wrapper_smoke.sv",
    ...
    IverilogTest(
        name="tb_femtorv32_capsule_derived_replay_smoke",
        workdir=Path("tb/system"),
        sources=(
            "tb_femtorv32_wrapper_smoke.sv",
            "../../third_party/femtorv32/femtorv32_quark.v",
    ...
    IverilogTest(
        name="tb_femtorv32_v2_replay_smoke",
        workdir=Path("tb/system"),
        sources=(
            "tb_femtorv32_v2_replay_smoke.sv",
            "../../third_party/femtorv32/femtorv32_quark.v",
            "../../rtl/event_tap.sv",
            "../../rtl/event_classifier.sv",
            "../../rtl/capsule_buffer.sv",
            ...
            "../../rtl/hash_signature.sv",
            *PICORV32_WRAPPER_V2_SOURCES,
            "../../rtl/rv32i_integration/femtorv32_replaycapsule_v2_wrapper.sv",
        ),
        include_dirs=("../../rtl", "../../rtl/replaycapsule_v2", "../../rtl/rv32i_integration", "../../third_party/femtorv32"),
        run_args=(
            "+MEMFILE=firmware/build/sensor_threshold_bug/failing.hex",
            "+EXPECTED_PROPERTY=3",
            "+SENSOR_VALUE=850",
...
VERILATOR_TARGETS = (
    ...
    VerilatorLintTarget(
        name="verilator_lint_replaycapsule_v2_self_replay_top",
        top="replaycapsule_v2_self_replay_top",
        sources=(
            "third_party/picorv32/picorv32.v",
            *COMMON_RTL,
            *ROOT_V2_RTL,
    ...
    VerilatorLintTarget(
        name="verilator_lint_replaycapsule_v2_self_replay_soc",
        top="replaycapsule_v2_self_replay_soc",
        sources=(
            "third_party/picorv32/picorv32.v",
            *COMMON_RTL,
            *ROOT_V2_RTL,
    ...
    VerilatorLintTarget(
        name="verilator_lint_femtorv32_v2_wrapper",
        top="femtorv32_replaycapsule_v2_wrapper",
        sources=(
            "third_party/femtorv32/femtorv32_quark.v",
            "rtl/event_tap.sv",
            "rtl/event_classifier.sv",
    ...
    VerilatorLintTarget(
        name="verilator_lint_femtorv32_wrapper",
        top="femtorv32_replaycapsule_wrapper",
        sources=("third_party/femtorv32/femtorv32_quark.v", *COMMON_RTL, "rtl/rv32i_integration/femtorv32_replaycapsule_wrapper.sv"),
        include_dirs=("rtl", "rtl/rv32i_integration", "third_party/femtorv32"),
    ),
    VerilatorLintTarget(
