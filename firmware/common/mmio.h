...
#define RC_PROFILE2_MMIO_SENSOR   ((volatile uint32_t *)0x40000040u)
#define RC_PROFILE2_MMIO_ACTUATOR ((volatile uint32_t *)0x40000044u)
#define RC_PROFILE2_MMIO_CONFIG   ((volatile uint32_t *)0x40000048u)
#define RC_PROFILE2_MMIO_COMMAND  ((volatile uint32_t *)0x4000004cu)
...
static inline void rc_write_command(uint32_t value) {
    *RC_MMIO_COMMAND = value;
}

static inline uint32_t rc_profile2_read_sensor(void) {
    return *RC_PROFILE2_MMIO_SENSOR;
}

static inline void rc_profile2_write_actuator(uint32_t value) {
    *RC_PROFILE2_MMIO_ACTUATOR = value;
}

static inline void rc_profile2_write_config(uint32_t value) {
    *RC_PROFILE2_MMIO_CONFIG = value;
}

static inline uint32_t rc_profile2_read_command(void) {
    return *RC_PROFILE2_MMIO_COMMAND;
}

static inline void rc_profile2_write_command(uint32_t value) {
    *RC_PROFILE2_MMIO_COMMAND = value;
}
