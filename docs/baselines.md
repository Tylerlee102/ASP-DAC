...
`scripts/collect_trace_sizes.py` computes available trace-size metrics from generated artifacts. It reports missing baselines as TODO rather than estimating them.
