...
- Full-core replay consume remains host-driven in the Verilator harness. The v2 replay-consume controller is tested RTL and maps standalone, but it is not yet wired into full-core instruction replay: capsule storage/streaming, core MMIO/IRQ replay muxing, PicoRV32 observed-event feedback, and autonomous replay-mode control are not integrated.
