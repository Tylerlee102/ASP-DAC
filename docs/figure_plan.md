...
| `results/processed/formal_checks.csv` | Yes | Verification status | Depth-2 event-tap, depth-8 property-checker, depth-8 replay-control, depth-12 capsule-buffer, and depth-16 recorder SMTBMC BMC/cover targets pass. |
