...
| `results/processed/hdl_checks.csv` | Yes | Verification status | Five directed Icarus module simulations, twelve PicoRV32 wrapper smokes, and Verilator lint-only checks pass. |
