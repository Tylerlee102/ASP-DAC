...
| `results/processed/hdl_checks.csv` | Yes | Verification status | Directed Icarus module simulations, five PicoRV32 wrapper smokes, and Verilator lint-only checks pass. |
