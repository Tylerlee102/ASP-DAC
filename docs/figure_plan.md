...
| `results/processed/hdl_checks.csv` | Yes | Verification status | Directed Icarus module simulations, one PicoRV32 wrapper smoke, and Verilator lint-only checks pass. |
