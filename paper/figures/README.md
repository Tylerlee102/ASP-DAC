...
| `../../results/processed/rtl_capsule_exports.csv` | Yes | RTL-smoke capsule export, negative-check, and PC-context source. |
...
| `../../results/processed/formal_checks.csv` | Yes | Bounded event-tap, replay-control, capsule-buffer, and recorder formal status source. |
