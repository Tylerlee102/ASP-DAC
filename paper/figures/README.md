...
| `../../results/processed/formal_checks.csv` | Yes | Bounded event-tap, event-classifier/slicer, property-checker, hash-signature, replay-control, capsule-buffer, and recorder formal status source. |
