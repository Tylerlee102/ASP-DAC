...
| PO-05 | A6 precise interrupt delivery | PARTIAL | rtl-smoke+firmware-sim | Seeded interrupt evidence covers RTL-smoke interrupt-race schedules and explicitly marks stronger randomized record/replay cases TODO; there is no full interrupt-controller proof or benchmark-wide randomized campaign. |
