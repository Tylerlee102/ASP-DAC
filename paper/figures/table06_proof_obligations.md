...
| PO-04 | A5 commit-index and same-index ordering | PASS_LOCAL | model+rtl-smoke | Comparator/order checks are generated fixtures and RTL-smoke export checks; full firmware-running RTL replay remains pending. |
