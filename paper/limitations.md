...
The current implementation is also an early scaffold: five PicoRV32 wrapper firmware smokes and generic synthesis numbers are measured, but benchmark-wide firmware-running tests, replay outputs, and mapped FPGA timing/resource numbers remain pending.
